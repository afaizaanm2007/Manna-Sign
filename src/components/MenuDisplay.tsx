...
const MenuDisplay = () => {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-background text-gray-200 font-bold">
      <div
      ...
      >
        ...
        <div className="w-1/4 flex-shrink-0 p-4 md:p-8">
          <div className="flex flex-row gap-x-4 mx-auto w-full h-full"> {/* Reduced gap-x */}
            ...
            <div className="bg-card p-4 rounded-lg shadow-lg flex-1 flex flex-col">
          ...
          <div className="bg-card p-6 rounded-lg shadow-lg flex-1 flex flex-col">
        ...
        <div className="w-1/4 flex-shrink-0 p-4 md:p-8">
          <div className="flex flex-row gap-x-4 mx-auto w-full h-full"> {/* Reduced gap-x */}
            ...
            <div className="bg-card p-6 rounded-lg shadow-lg flex-[2.5] flex flex-col">
