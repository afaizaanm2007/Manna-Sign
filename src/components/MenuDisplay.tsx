  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-gray-950 text-gray-200 font-bold">
      ...
      <div className="absolute top-16 bottom-16 left-0 w-16 overflow-hidden z-20">
        <div 
          className="w-full h-full bg-[url('/red-pattern-transparent.png')] bg-repeat-y bg-left bg-[size:100%_auto]"
      ...
      <div className="absolute top-16 bottom-16 right-0 w-16 overflow-hidden z-20">
        <div 
          className="w-full h-full bg-[url('/red-pattern-transparent.png')] bg-repeat-y bg-right bg-[size:100%_auto]"
          style={{ transform: 'rotate(90deg)' }}
        ></div>
      </div>
