    ...
    <div className="relative w-screen h-screen overflow-hidden bg-gray-950 text-gray-200 font-bold">
      ...
      <div className="absolute top-16 bottom-16 left-16 right-16 bg-yellow-400 text-gray-900 flex flex-row z-10">
        ...
        >
          ...
          <div className="w-screen flex-shrink-0 relative h-full">
            {/* Left Inner Patterned Border */}
            ...
            <div className="absolute inset-y-0 left-8 right-8 flex flex-row gap-x-4 p-4 md:p-8">
